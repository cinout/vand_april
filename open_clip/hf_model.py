...
# [from author]: ?last - for gpt-like models
_POOLERS = {}
...
class HFTextEncoder(nn.Module):
    ...
    def __init__(
        ...
        # [from author]: find better way to get this information
        ...
        if config is None:
            ...
            # [from author]: do all model configs have this attribute? PretrainedConfig does so yes??
            if (
