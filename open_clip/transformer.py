    ...
    def forward(
        ...
        for r in self.resblocks:
            ...
            if self.grad_checkpointing and not torch.jit.is_scripting():
                # [from author]: handle kwargs https://github.com/pytorch/pytorch/issues/79887#issuecomment-1161758372
...
class VisionTransformer(nn.Module):
    ...
    def init_parameters(self):
        ...
        # [from author] experiment if default PyTorch init, below, or alternate init is best.
